...
<!--          <span class="iconfont icon-xiaomi"></span>-->
          <img style="border-radius: 50%;margin-top: 0.1rem; " src="https://zuifeiyi-1258006205.cos.ap-beijing.myqcloud.com/article/zuifeiyiLogo.jpeg" alt="">
        </div>
  ...
  export default {
    data() {
      return {
        ...
        shoplist02: [
          {
            src: 'https://si.geilicdn.com/bj-wd-502441367-1516804927220-1554607960_1080_1440.jpg?w=30&h=30&cp=1',
            title: '原创耳坠「红泪」一对',
            con: ' 材料：黄铜、玛瑙珠 ',
            money: 89,
            href: '/detail/1012'
